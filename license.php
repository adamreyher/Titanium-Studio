...
?>
		  ...
		  <div id="body">
			  ...
			  <div class="encase">
				  <div class="box" style="float:left; width: 440px;">
					  <a name="output"><h2>Output <span class="accent">Content</span></h2></a>
					  <p>
					  ...
					  <p>
						  For third-party images/icons and their respective licenses, please see <a href="#images-icons" rel="anchor">Images &amp; Icons</a>.
					  </p>
				  </div>
				  <div class="box" style="float:right; width: 440px;">
					  <a name="phpBB"><h2>Forum <span class="accent">Software</span></h2></a>
					  <p>
					  ...
					  <ul class="credits">
						  <li><strong>Copyright:</strong> 2005, phpBB Group <a href="http://www.phpbb.com" rel="external">http://www.phpbb.com</a>
						  <li><strong>License:</strong> GNU General Public License, Version 2
						  <li><strong>License URL:</strong> <a href="http://www.opensource.org/licenses/gpl-2.0.php" rel="external">http://www.opensource.org/licenses/gpl-2.0.php</a>
					  </ul>
				  </div>
			  </div>
			  <div class="encase">
				  <div class="box">
					  <a name="javascript"><h2>JavaScript <span class="accent">Libraries</span></h2></a>
					  <p>
					  ...
					  <ul class="credits">
						  <li><strong>Copyright:</strong> 2010, John Resig <a href="http://www.jquery.com" rel="external">http://www.jquery.com</a>
						  <li><strong>License:</strong> MIT License
						  <li><strong>License URL:</strong> <a href="http://www.opensource.org/licenses/mit-license.php" rel="external">http://www.opensource.org/licenses/mit-license.php</a>
					  </ul>
					  ...
					  <ul class="credits">
						  <li><strong>Copyright:</strong> 2009, Jack Moore  <a href="http://www.colorpowered.com" rel="external">http://www.colorpowered.com</a>
						  <li><strong>License:</strong> MIT License
						  <li><strong>License URL:</strong> <a href="http://www.opensource.org/licenses/mit-license.php" rel="external">http://www.opensource.org/licenses/mit-license.php</a>
					  </ul>
					  ...
					  <ul class="credits">
						  <li><strong>Copyright:</strong> 2009, Craig Thompson <a href="http://craigsworks.com" rel="external">http://craigsworks.com</a>
						  <li><strong>License:</strong> MIT License
						  <li><strong>License URL:</strong> <a href="http://www.opensource.org/licenses/mit-license.php" rel="external">http://www.opensource.org/licenses/mit-license.php</a>
					  </ul>
				  </div>
